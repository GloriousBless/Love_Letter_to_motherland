$(function() {
    ...
    var musicImgsData = ['D:/html/Code_Love_Letter/imag/盛哲.png', 'img/bg1.jpg', 'img/bg2.jpg'] // 图片地址数组
    var musicNameData = ['在你的身边 ']; // 歌曲名数组
    var artistNameData = ['盛哲'] // 创作歌手数组
    var musicUrls = ['在你的身边 (伴奏).mp3']; // 歌曲mp3数组
